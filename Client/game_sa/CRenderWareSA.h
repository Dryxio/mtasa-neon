...
public:
    ...
    RwTexture*         AcquireModelTexture(ushort usModelID, const SString& strTxdName, const SString& strTextureName) override;
    void               ReleaseTextureReference(RwTexture* pTexture) override;
