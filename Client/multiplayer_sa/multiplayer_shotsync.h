...
#define HOOKPOS_CTaskSimpleGangDriveBy__FireEpilogue 0x62833E
#define HOOKPOS_CWeapon_FireInstantHit_PlayerSpread  0x73FF1E
...
VOID HOOK_CTaskSimpleGangDriveByFireHelper__IsPlayer();
VOID HOOK_CTaskSimpleGangDriveBy__FireEpilogue();
VOID HOOK_CWeapon_FireInstantHit_PlayerSpread();
