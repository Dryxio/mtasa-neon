...
protected:
    ...
    CGUICheckBox*             m_pCheckBoxDistantLightSearchlights;
    CGUICheckBox*             m_pDistantLightAutomatic;
    CGUICheckBox*             m_pDistantLightGrowth;
    CGUIScrollBar*            m_pDistantLightCurves[4]{};
    CGUILabel*                m_pDistantLightCurveValues[4]{};
    std::vector<CGUIElement*> m_DistantLightAdvancedControls;
    ...
    bool OnDistantLightAdvancedChanged(CGUIElement* pElement);
