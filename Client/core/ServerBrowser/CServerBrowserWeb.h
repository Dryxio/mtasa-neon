...
public:
    ...
    static bool CaptureSettingsInputMessage(UINT message, WPARAM wParam, LPARAM lParam);
    ...
    static bool NotifyConnectionPasswordRequired(const std::string& host, unsigned short port, bool rejected);
    static bool NotifyConnectionSucceeded();
    static void RelinquishConnectionUi();
    static bool CanDeferQuestionDialog();
    static bool ShowQuestionDialog(const std::string& title, const std::string& message, const std::vector<std::string>& buttons);
    static bool CloseQuestionDialog();
    static bool ShowMessageDialog(const std::string& title, const std::string& message, unsigned int flags);
    static bool CloseMessageDialog();
...
private:
    ...
    bool                                 m_serverBrowserActive{};
    bool                                 m_settingsReady{};
    bool                                 m_connectionUiActive{};
    bool                                 m_messageDialogActive{};
    bool                                 m_messageDialogOpenedMenu{};
    bool                                 m_questionDialogActive{};
    bool                                 m_questionDialogOpenedMenu{};
    bool                                 m_questionDialogResponded{};
    unsigned int                         m_questionDialogButtonCount{};
    unsigned int                         m_messageDialogId{};
    std::string                          m_messageDialogAction;
    bool                                 m_refreshing{};
    bool                                 m_sentRefreshFinished{};
    bool                                 m_hasSentRefreshProgress{};
    unsigned int                         m_lastRefreshScanned{};
    unsigned int                         m_lastRefreshTotal{};
