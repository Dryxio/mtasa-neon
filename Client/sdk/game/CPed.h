...
public:
    ...
    virtual void                     SetNativeChokingUsesNonPlayerBehavior(bool enabled) = 0;
    ...
    virtual void                     SetNativeJumpUsesNonPlayerBehavior(bool enabled) = 0;
    virtual bool                     NativeJumpUsesNonPlayerBehavior() const = 0;
