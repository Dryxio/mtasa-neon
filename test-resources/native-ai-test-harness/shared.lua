NATIVE_AI_HARNESS = {
    ...
    scenarios = {
        ...
        gang_two_armed_two_unarmed_melee = {
            id = "gang-two-armed-two-unarmed-melee-v1",
            fightingStyle = 4,
            pedModels = {102, 103, 104, 102},
            pedWeapons = {22, 0, 0, 22},
            attackedIndex = 1,
            sourceWeapon = 0,
            expectedResponse = "fight",
            expectedAllocator = "all-kill",
            owner = {2490.0, -1668.0, 13.35, 90.0},
            victim = {2498.0, -1668.0, 13.35, 270.0},
            peds = {
                {2494.0, -1666.2, 13.35, 90.0},
                {2494.0, -1667.4, 13.35, 90.0},
                {2494.0, -1668.6, 13.35, 90.0},
                {2494.0, -1669.8, 13.35, 90.0},
            },
        },
        gang_armed_handoff = {
