...
// Neon embeds an unshared-memory module on MSVC x86, whose C11 mode does
// not enable _Atomic. Do not compile unused shared-memory support.
#if __STDC_VERSION__ >= 201112L && !defined(NEON_WASM_UNSHARED_ONLY)
